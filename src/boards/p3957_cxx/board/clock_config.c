...
- {id: CTIMER4_clock.outFreq, value: 48 MHz}
...
- {id: FLEXCOMM7_clock.outFreq, value: 12 MHz}
- {id: FLEXCOMM8_clock.outFreq, value: 12 MHz}
- {id: FLEXCOMM9_clock.outFreq, value: 12 MHz}
- {id: FLEXIO_clock.outFreq, value: 12 MHz}
- {id: FRO_12M_clock.outFreq, value: 12 MHz}
- {id: FRO_HF_clock.outFreq, value: 48 MHz}
- {id: I3C0_FCLK_clock.outFreq, value: 8 MHz}
- {id: I3C0_SLOW_TC_clock.outFreq, value: 24 MHz}
- {id: I3C0_SLOW_clock.outFreq, value: 1 MHz}
- {id: I3C1_FCLK_clock.outFreq, value: 8 MHz}
- {id: I3C1_SLOW_TC_clock.outFreq, value: 24 MHz}
...
- {id: CMP1FCLKDIV_HALT, value: Enable}
- {id: CMP1RRCLKDIV_HALT, value: Enable}
...
- {id: SYSCON.CTIMERCLKSEL4.sel, value: SCG.FRO_HF}
...
- {id: SYSCON.FCCLKSEL7.sel, value: SCG.FRO_12M}
- {id: SYSCON.FCCLKSEL8.sel, value: SCG.FRO_12M}
- {id: SYSCON.FCCLKSEL9.sel, value: SCG.FRO_12M}
- {id: SYSCON.FLEXIOCLKSEL.sel, value: SCG.FRO_12M}
- {id: SYSCON.FREQMEREFCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.FREQMETARGETCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.I3C0FCLKDIV.scale, value: '6'}
- {id: SYSCON.I3C0FCLKSEL.sel, value: SCG.FRO_HF}
- {id: SYSCON.I3C0FCLKSTCDIV.scale, value: '2'}
- {id: SYSCON.I3C0FCLKSTCSEL.sel, value: SYSCON.I3C0FCLKSEL}
- {id: SYSCON.I3C1FCLKDIV.scale, value: '6'}
- {id: SYSCON.I3C1FCLKSEL.sel, value: SCG.FRO_HF}
- {id: SYSCON.I3C1FCLKSTCDIV.scale, value: '2', locked: true}
- {id: SYSCON.I3C1FCLKSTCSEL.sel, value: SYSCON.I3C1FCLKSEL}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    CLOCK_AttachClk(kFRO_HF_to_I3C0FCLK);                 /*!< Switch I3C0FCLK to FRO_HF */
    CLOCK_AttachClk(kI3C0FCLK_to_I3C0FCLKSTC);                 /*!< Switch I3C0FCLKSTC to I3C0FCLK */
    CLOCK_AttachClk(kFRO_HF_to_I3C1FCLK);                 /*!< Switch I3C1FCLK to FRO_HF */
    CLOCK_AttachClk(kI3C1FCLK_to_I3C1FCLKSTC);                 /*!< Switch I3C1FCLKSTC to I3C1FCLK */
    ...
    CLOCK_AttachClk(kFRO12M_to_FLEXIO);                 /*!< Switch FLEXIO to FRO12M */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivI3c0FClk, 6U);           /*!< Set I3C0FCLKDIV divider to value 6 */
    CLOCK_SetClkDiv(kCLOCK_DivI3c0FClkStc, 2U);           /*!< Set I3C0FCLKSTCDIV divider to value 2 */
    CLOCK_SetClkDiv(kCLOCK_DivI3c0FClkS, 1U);           /*!< Set I3C0FCLKSDIV divider to value 1 */
    CLOCK_SetClkDiv(kCLOCK_DivI3c1FClk, 6U);           /*!< Set I3C1FCLKDIV divider to value 6 */
    CLOCK_SetClkDiv(kCLOCK_DivI3c1FClkStc, 2U);           /*!< Set I3C1FCLKSTCDIV divider to value 2 */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivFlexcom8Clk, 1U);           /*!< Set FLEXCOMM8CLKDIV divider to value 1 */
