                                                       ...
                                                       KeyRollbackSelect key_rollback_select)
{
    ...
    auto sts = cfpa_driver.increase_cfpa_secure_version(sec_version, key_rollback_select);
    if (sts != kStatus_Success) {
        flash_status = kstatus_to_status(sts);
    }
                                                         ...
                                                         KeyRollbackSelect key_rollback_select)
{
    ...
    auto sts = cfpa_driver.increase_cfpa_image_key_revoke(key_revoke, key_rollback_select);
    if (sts != kStatus_Success) {
        flash_status = kstatus_to_status(sts);
    }
