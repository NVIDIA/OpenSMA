...
constexpr Address RemapSize          = 0x100000;
constexpr Address MaxAddress         = 0x200000;
constexpr Address LoggerStartAddress = 0xDC000;
constexpr Address FirmwareMaxSize    = 0x80000;
