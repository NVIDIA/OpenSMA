...
private:
    ...
    static void        master_edma_callback(LPSPI_Type*                 base,
                                            lpspi_master_edma_handle_t* handle,
                                            status_t                    status,
                                            void*                       userData);

    static void
    get_dma_channels(nv::spi::Flexcomm flexcomm, uint32_t& tx_channel, uint32_t& rx_channel);
    lpspi_master_edma_handle_t _edma_handle;
    edma_handle_t              _lpspiEdmaMasterRxRegToRxDataHandle;
    edma_handle_t              _lpspiEdmaMasterTxDataToTxRegHandle;
