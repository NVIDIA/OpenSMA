...
public:
    ...
    static uint8_t      write_mctp_svc(uint8_t* data, uint32_t length);
    uint8_t             write_mctp(uint8_t* data, uint32_t length);
    static uint8_t      write_mctp_impl(uint8_t* data, uint32_t length);
    static uint8_t      write_hid_svc(uint8_t* data, uint32_t length);
    uint8_t             write_hid(uint8_t* data, uint32_t length);
    static uint8_t      write_hid_impl(uint8_t* data, uint32_t length);
    static usb_status_t enable_mctp_rx_svc();
    static usb_status_t enable_mctp_rx_impl();
    usb_status_t        enable_mctp_rx();
    static usb_status_t enable_hid_rx_svc();
    static usb_status_t enable_hid_rx_impl();
