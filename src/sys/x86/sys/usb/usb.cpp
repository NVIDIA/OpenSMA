...
uint8_t
Driver::init_svc(void* mctp_buffer0, void* mctp_buffer1, void* hid_buffer0, void* hid_buffer1)
{
    return 0;
}

uint8_t
Driver::init(void* mctp_buffer0, void* mctp_buffer1, void* hid_buffer0, void* hid_buffer1)
{
    return 0;
}
