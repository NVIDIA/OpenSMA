...
public:
    ...
    // TODO change this whole system to an array of addresses set at class initalization
    //    and have option for ack all addresses
...
private:
    ...
    address_valid_callback_t address_valid_callback;
