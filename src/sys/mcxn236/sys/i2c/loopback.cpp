...
{
    // Dummy implementation for MCXN236: mark this port as "NotI2C" (skipped).
    // The selftest caller initializes all entries to 0xFF and expects each port
    // to update its slot deterministically before clearing IsRunning.
