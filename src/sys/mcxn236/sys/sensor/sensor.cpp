...
// sensor
    ...
    if (is_sensor_init == false) {
        ...
        // VERF seems impact I3C communication since we enable external VREF, disable it
...
// sensor
    ...
    // coverity[cert_int30_c_violation] unsigned integer arithmetic take care this case
    while (nv::ctimer::Driver::read_ticks() - t1 < MaxRetriesTicks) {
