...
void Driver::set_shared_base_stream_buffer_address([[maybe_unused]] uint32_t address)
{
    return;
}
...
nv::ipc::StreamBuffer::IdType Driver::get_stream_buffer_id([[maybe_unused]] bool is_tx)
{
    return 0;
}

StreamBufferHandle_t Driver::get_stream_buffer_handle([[maybe_unused]] bool is_tx)
{
    return nullptr;
}
...
void Driver::set_core_communication_ready([[maybe_unused]] bool ready)
{
    return;
}
