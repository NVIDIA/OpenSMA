...
void Driver::init()
{
    ...
    PWM_UpdatePwmDutycycle(
        PWM0_PERIPHERAL, PWM0_SM0, kPWM_PwmA, kPWM_SignedCenterAligned, DefaultPwmPercent);
    PWM_UpdatePwmDutycycle(
        PWM0_PERIPHERAL, PWM0_SM0, kPWM_PwmB, kPWM_SignedCenterAligned, DefaultPwmPercent);
