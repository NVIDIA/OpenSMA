...
constexpr inline std::array<QueueInfo, int(QueueId::End)> QueueInfos{
    ...
    {              QueueId::Test7,  64,                                                 16},
    {              QueueId::Test8, 128,                                                  8},
    {  QueueId::MctpUsI2c0Request,   1,                                                 72},
...
enum BootedEventBits : uint32_t
{
    ...
    Usb   = nv::common::bit(3),
    Flash = nv::common::bit(4),
#ifdef NV_UNITTEST
    Unittest,
#endif
    Logger         = nv::common::bit(5),
    Spdm           = nv::common::bit(6),
    GpuPwrCtrl     = nv::common::bit(7),
...
enum class HotplugMode : uint8_t
{
    MODE_INVALID = 0xffU
};
constexpr HotplugMode                          ModeHotplug     = HotplugMode::MODE_INVALID;
constexpr static uint8_t                       NumNhpInstances = 2U;
constexpr static uint8_t                       NumE1sDrives    = 4U;
