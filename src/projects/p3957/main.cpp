...
int main()
{
    ...
    // TODO: Uncomment one (and only one) of the following tasks
    // VPP is for BF3+IPEX bridge
    // NHP is for early firmware CX8
    // AHS is for POR CX8 firmware
    vpp::Task::make(nhp::vpp_task_config);
    // nhp::Task::make(nhp::nhp_task_config);
