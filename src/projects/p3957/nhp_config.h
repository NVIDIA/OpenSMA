...
static_assert(((NumNhpInstances == 1) || (NumNhpInstances == 2) || (NumNhpInstances == 4)),
              "NHP Can only have 1, 2 or 4 instances");
...
#elif (NUM_HOTPLUG_INSTANCES == 2U)
constexpr std::array<E1sOutputPins, NumE1sDrives> Nhp0driveOutputPins = {
    Drive0OutputPins, Drive1OutputPins, Drive2OutputPins, Drive3OutputPins};
constexpr std::array<E1sInputPins, NumE1sDrives> Nhp0driveInputPins = {
    Drive0InputPins, Drive1InputPins, Drive2InputPins, Drive3InputPins};

#elif (NUM_HOTPLUG_INSTANCES == 4U)
constexpr std::array<E1sOutputPins, NumE1sDrives> Nhp0driveOutputPins = {Drive0OutputPins,
                                                                         Drive1OutputPins};
constexpr std::array<E1sInputPins, NumE1sDrives>  Nhp0driveInputPins  = {Drive0InputPins,
                                                                         Drive1InputPins};
...
constexpr std::array<E1sOutputPins, NumE1sDrives> Nhp1driveOutputPins = {
    Drive4OutputPins, Drive5OutputPins, Drive6OutputPins, Drive7OutputPins};
constexpr std::array<E1sInputPins, NumE1sDrives> Nhp1driveInputPins = {
    Drive4InputPins, Drive5InputPins, Drive6InputPins, Drive7InputPins};
...
constexpr static nv::vpp::TaskConfig vpp_task_config = {
    ...
    .task_name = "VPP",
#if (NUM_HOTPLUG_INSTANCES == 1U)
    .vpp_configs = {vppConfig0},
#elif (NUM_HOTPLUG_INSTANCES == 2U)
    .vpp_configs = {vppConfig0, vppConfig1},
#elif (NUM_HOTPLUG_INSTANCES == 4U)
...
// -------------------------------------
// Hotplug Configuration Specificy to NHP Mode
constexpr static nv::nhp::NHP::NhpConfig nhpConfig0 = {
    .i2c_bus        = static_cast<i2c::Port>(ipc::VPP_CPU0_I2C_PORT),
    .output_pins    = Nhp0driveOutputPins,
    .input_pins     = Nhp0driveInputPins,
    .interrupt_port = Nhp0InterruptPort,
    .interrupt_pin  = Nhp0InterruptPin
    //
};

#if (NUM_HOTPLUG_INSTANCES == 2U)
constexpr static nv::nhp::NHP::NhpConfig nhpConfig1 = {
    .i2c_bus        = static_cast<i2c::Port>(ipc::VPP_CPU1_I2C_PORT),
    .output_pins    = Nhp1driveOutputPins,
    .input_pins     = Nhp1driveInputPins,
    .interrupt_port = Nhp1InterruptPort,
    .interrupt_pin  = Nhp1InterruptPin,
    //
};
...
constexpr static nv::nhp::NHP::NhpConfig nhpConfig2 = {
    .i2c_bus        = static_cast<i2c::Port>(ipc::VPP_CPU1_I2C_PORT),
    .output_pins    = Nhp2driveOutputPins,
    .input_pins     = Nhp2driveInputPins,
    .interrupt_port = Nhp2InterruptPort,
    .interrupt_pin  = Nhp2InterruptPin,
    //
};
constexpr static nv::nhp::NHP::NhpConfig nhpConfig3 = {
    .i2c_bus        = static_cast<i2c::Port>(ipc::VPP_CPU1B_I2C_PORT),
    .output_pins    = Nhp3driveOutputPins,
    .input_pins     = Nhp3driveInputPins,
    .interrupt_port = Nhp3InterruptPort,
    .interrupt_pin  = Nhp3InterruptPin,
    //
};
#endif

constexpr static nv::nhp::TaskConfig nhp_task_config = {
    .task_id   = ipc::TaskId::NHP,
    .task_name = "NHP",
#if (NUM_HOTPLUG_INSTANCES == 1U)
    .nhp_configs = {nhpConfig0}
#elif (NUM_HOTPLUG_INSTANCES == 2U)
    .nhp_configs = {nhpConfig0, nhpConfig1}
#elif (NUM_HOTPLUG_INSTANCES == 4U)
    .nhp_configs = {nhpConfig0, nhpConfig1, nhpConfig2, nhpConfig3}
#endif
    //
};
