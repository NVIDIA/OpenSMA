...
private:
    ...
    semaphore_take(nv::ipc::Queue::Usecs timeout = std::chrono::microseconds(50000));
    static nv::ipc::Queue::Status
    semaphore_give(nv::ipc::Queue::Usecs timeout = std::chrono::microseconds(50000));

    nv::ipc::Queue::Status receive_request_from_queue(const Request& request);
    nv::ipc::Queue::Status send_response_to_queue(Response& response);
