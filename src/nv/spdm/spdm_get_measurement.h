...
constexpr MeasurementVersionValueT MeasurementVersion{0x0, 0x0, 0x0, 0x01};
...
constexpr std::array<MeasInfoT, MeasMax> MeasInfos = {
    {{.meas_type = 0, .meas_size = 0},      // MeasGetNumMeas
     ...
     {.meas_type = 0x83,
      .meas_size = nv::debugtoken::DebugTokenConfigTSize},  // MeasDebugTokenConfiguration
     {.meas_type = 0x83,
