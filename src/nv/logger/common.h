...
struct Event
{
    ...
    static constexpr EventStructItem I2CRecoverySuccess = {0x0509, Level::Info};
    static constexpr EventStructItem I2CRecoveryFail    = {0x050a, Level::Error};
    // I3C
...
struct AsciiArr
{
    std::array<uint8_t, sizeof(Item) - 1> ascii_arr{};
    bool                                  flag;
};
