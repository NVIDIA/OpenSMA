...
struct Event
{
    ...
    static constexpr EventStructItem I3CFailedToProcessDaaV1  = {0x0602, Level::Error};
    static constexpr EventStructItem I3CError                 = {0x0603, Level::Error};
    static constexpr EventStructItem I3CWriteFailV1           = {0x0604, Level::Error};
    static constexpr EventStructItem I3CReadFailV1            = {0x0605, Level::Error};
    static constexpr EventStructItem I3CSetAddrV1             = {0x0606, Level::Info};
    static constexpr EventStructItem I3COobResetV1            = {0x0607, Level::Info};
    static constexpr EventStructItem I3CUnhandledErrorV1      = {0x0608, Level::Error};
    static constexpr EventStructItem I3CCccErrorV1            = {0x0609, Level::Error};
    static constexpr EventStructItem I3CInit                  = {0x060a, Level::Info};
    static constexpr EventStructItem I3CUnknownIBIV1          = {0x060b, Level::Error};
    static constexpr EventStructItem I3CPecInvalidV1          = {0x060c, Level::Error};
    static constexpr EventStructItem I3CTimeoutV1             = {0x060d, Level::Error};
    static constexpr EventStructItem I3CNackV1                = {0x060e, Level::Error};
    static constexpr EventStructItem I3CIbiDropV1             = {0x060f, Level::Error};
    static constexpr EventStructItem I3CQueueDropV1           = {0x0610, Level::Error};
    static constexpr EventStructItem I3CApStatusUpdate        = {0x0611, Level::Info};
    static constexpr EventStructItem I3CI2CWriteFailV1        = {0x0612, Level::Error};
    static constexpr EventStructItem I3CI2CReadFailV1         = {0x0613, Level::Error};
    ...
    static constexpr EventStructItem I3CDaaMismatchV1         = {0x0619, Level::Error};
    static constexpr EventStructItem I3CIgnoreIbiStateV1      = {0x061a, Level::Info};
    static constexpr EventStructItem I3CIgnoreIbiTypeV1       = {0x061b, Level::Info};
    static constexpr EventStructItem I3CUnhandledErrorMStatus = {0x061c, Level::Error};
    static constexpr EventStructItem I3CUnhandledErrorV2      = {0x061d, Level::Error};
    static constexpr EventStructItem I3CFailedToResetDaaV2    = {0x061e, Level::Error};
    static constexpr EventStructItem I3CFailedToProcessDaaV2  = {0x061f, Level::Error};
    static constexpr EventStructItem I3CWriteFailV2           = {0x0620, Level::Error};
    static constexpr EventStructItem I3CReadFailV2            = {0x0621, Level::Error};
    static constexpr EventStructItem I3CSetAddrV2             = {0x0622, Level::Info};
    static constexpr EventStructItem I3COobResetV2            = {0x0623, Level::Info};
    static constexpr EventStructItem I3CCccErrorV2            = {0x0624, Level::Error};
    static constexpr EventStructItem I3CUnknownIBIV2          = {0x0625, Level::Error};
    static constexpr EventStructItem I3CPecInvalidV2          = {0x0626, Level::Error};
    static constexpr EventStructItem I3CTimeoutV2             = {0x0627, Level::Error};
    static constexpr EventStructItem I3CNackV2                = {0x0628, Level::Error};
    static constexpr EventStructItem I3CIbiDropV2             = {0x0629, Level::Error};
    static constexpr EventStructItem I3CQueueDropV2           = {0x062a, Level::Error};
    static constexpr EventStructItem I3CI2CWriteFailV2        = {0x062b, Level::Error};
    static constexpr EventStructItem I3CI2CReadFailV2         = {0x062c, Level::Error};
