...
public:
    ...
    Status        init();
    static Status add(EventId               event,
                      Level                 level,
                      EventData             data,
                      OutputDirection       output,
                      bool                  wait    = false,
                      nv::ipc::Queue::Usecs timeout = nv::ipc::Queue::Usecs::max());
    static Status add_from_isr(EventId         event,
                               Level           level,
                               EventData       data,
...
inline auto info(EventStructItem       event,
                 EventData             data    = {0},
                 OutputDirection       dir     = OutputDirection::Both,
                 nv::ipc::Queue::Usecs timeout = nv::ipc::Queue::Usecs(10000))
{
    return Logger::add(event.unique_id,
                       event.default_level == logger::Level::Unknown ? Level::Info
                                                                     : event.default_level,
                       data,
                       dir,
                       false,
...
inline auto info_wait(EventStructItem       event,
                      EventData             data    = {0},
                      OutputDirection       dir     = OutputDirection::Both,
                      nv::ipc::Queue::Usecs timeout = nv::ipc::Queue::Usecs::max())
{
...
inline auto error(EventStructItem       event,
                  EventData             data    = {0},
                  OutputDirection       dir     = OutputDirection::Both,
                  nv::ipc::Queue::Usecs timeout = nv::ipc::Queue::Usecs::max())
{
    return Logger::add(event.unique_id,
                       event.default_level == logger::Level::Unknown ? Level::Error
                                                                     : event.default_level,
                       data,
                       dir,
                       true,
...
inline auto error_no_wait(EventStructItem       event,
                          EventData             data    = {0},
                          OutputDirection       dir     = OutputDirection::Both,
                          nv::ipc::Queue::Usecs timeout = nv::ipc::Queue::Usecs::max())
{
