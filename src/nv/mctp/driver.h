...
public:
    ...
    constexpr static bool IsApgoodOn = false;
...
protected:
    ...
    void        on_wdt_event();
    ipc::Queue& get_queue(Client client);
    ...
    ipc::Queue& _usb_us_queue;
    ipc::Queue& _i2c_us_queue;
    ipc::Queue& _i2c0_ds_queue;
    ipc::Queue& _i2c1_ds_queue;
    ipc::Queue& _i2c2_ds_queue;
    ipc::Queue& _i2c3_ds_queue;
    ipc::Queue& _i3c0_ds_queue;
    ipc::Queue& _i3c1_ds_queue;
    ipc::Queue& _spi0_queue;
    ipc::Queue& _spi1_queue;
    ipc::Queue& _spi2_queue;
    ipc::Queue& _pldm_queue;
    ipc::Queue& _spdm_queue;
    ipc::Queue& _cmd_queue;
    ipc::Queue& _fake_queue;
...
public:  // static api section
    ...
    static Status mctp_send_cmd(CmdCode cmd, uint8_t data1 = 0, uint8_t data2 = 0);
    static Status mctp_send_from_spi_0(nv::ipc::Queue::Item& item);
    static Status mctp_send_from_spi_1(nv::ipc::Queue::Item& item);
    static Status mctp_send_from_spi_2(nv::ipc::Queue::Item& item);
    static Status mctp_send_from_us_i2c_0(ipc::Queue::Item& item);
    static Status mctp_send_from_us_usb(ipc::Queue::Item& item);
    static Status mctp_send_from_ds_i2c_0(ipc::Queue::Item& item);
    static Status mctp_send_from_ds_i2c_1(ipc::Queue::Item& item);
    static Status mctp_send_from_ds_i2c_2(ipc::Queue::Item& item);
    static Status mctp_send_from_ds_i2c_3(ipc::Queue::Item& item);
    static Status mctp_send_from_ds_i3c_0(ipc::Queue::Item& item);
    static Status mctp_send_from_ds_i3c_1(ipc::Queue::Item& item);
    ...
    static Status endpoint_status_change(uint8_t end_point, uint8_t status);
