...
TEST(Mctp, SetEpId)
{
    ...
    mctp::Driver::mctp_send(item, mctp::Client::UsI2c);
...
TEST(Mctp, GetEpUuid)
{
    ...
    nv::mctp::Driver::mctp_send(item, mctp::Client::UsI2c);
};
