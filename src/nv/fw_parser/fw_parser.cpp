...
namespace {  // declare some helper function for read from flash
...
{
    auto nv_header_address_check = check_wrap(get_fw_image_address(InputParseingFwType),
                                              NvHeaderOffset);
...
get_certificate_block_address(const ParsingFwType InputParseingFwType)
{
    ...
    auto certificate_block_address_check = check_wrap(
        get_fw_image_address(InputParseingFwType),
