...
# -- global defines ----------------------------------------------------------------------------
#  SIGN_KEYSET  S0 -> Internal Usage, Dummy Key
#  SIGN_KEYSET S14 -> External Usage
#  Default:  External/S14
SIGN_KEYSET         ?= S14

# SIGN_KEYSET == S14 / EXTERNAL
ifeq ($(SIGN_KEYSET), S14)
AP_SKU_PRJ          := 0x28
GD_MCU_SSDID		:= 0x2213
else
AP_SKU_PRJ          := 0x8
...
GLOBAL_DEDINES ?= -DDEBUG -fno-common -ffunction-sections -fdata-sections -DI2C_RETRY_TIMES=4000U
