...
is
   ...
   procedure Pldm_Write (Buffer      : ARR_NvU8_IDX32;
                            Offset      : NvU32;
                            Size   :     NvU32;
                            Err         : in out NvU16);
   pragma Import (C, Pldm_Write, "pldm_write");

   procedure Pldm_Update_Pds (Status   : NvU8;
                              Err      : in out NvU16);
   ...
   procedure Get_Fw_Info (Component_Id : in out NvU16;
   ...
   procedure Request_Authentication;
   pragma Import (C, Request_Authentication, "request_authentication");

   procedure Print_Msg (Msg  : ARR_NvU8_IDX32;
                        Data : NvU32);
