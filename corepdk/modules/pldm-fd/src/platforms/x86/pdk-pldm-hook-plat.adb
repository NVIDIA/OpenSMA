...
is
   ...
   is
      ...
      type Record_Pldmfw_Ret is record
         Ret0 : NvU8;
         Ret1 : NvU8;
      end record with
      ...
      function Uc_Pldmfw_Ret_To_Rec is new Ada.Unchecked_Conversion
        (Source => Pldmfw_Ret, Target => Record_Pldmfw_Ret);
   begin
   ...
   is
      ...
      Data_Msg : String := "0x00000000\n";
   begin
      --  Nv.Common.Console.Print (Msg);
      To_Hex_String (Str => Data_Msg (3 .. 10), Value => data);
      --  Nv.Common.Console.Print (Data_Msg);
   ...
   is
      ...
      Buffer : aliased constant Payload_As_Arr_Type with
   ...
   begin
      ...
      then
         ...
         for I in 0 .. (Size_To_Send - 1)
         loop
            To_Hex_String (Str => Byte_Char (1 .. 2), Value => Buffer (I));
      ...
      Enqueue (Q => Posix_Ctx.Rx_Queue, Item => Buffer);
   ...
   is
      ...
      Err           : NvU16 := 0;
      subtype Payload_As_Arr_Type is
        ARR_NvU8_IDX32 (0 .. (Get_Size_Bytes (Payload_Type'Size) - 1));
      Buffer : aliased constant Payload_As_Arr_Type with
        Address => Data'Address, Import;
   ...
   begin
      ...
      --  Pldm_Write(Component_Id      => Component_Id,
      --             Buffer       => Buffer,
      --             Offset       => Offset,
      --             Size         => Size_To_Write,
      --             Err          => Err);
   ...
   procedure Pldm_Hook_Get_Time_Milli_Seconds (Timestamp : out NvU32) is
   begin
   ...
   procedure Pldm_Hook_Clear_Timer (Ret : out Pldmfw_Ret) is
   begin
   ...
   is
      Mcu_Component_Id  : constant NvU16 := 16#FF02#;  -- mcu
      Unused_Build_Mode : NvU8;
      Unused_Fw_State   : NvU8;
      Is_Valid          : NvU8           := 0;

      --  ArrLen            : NvU32 := 0;
      --  All_Comp_Id : Comp_Id_Array with Address => Get_Arr_Comp_id_Address;
   ...
   begin
      ...
      --  Get_Fw_Info (Input_Component_Id => Mcu_Component_Id,
      --               Output_Component_Id => Component_Infos(Component_Length).Id,
      ...
      --  Get_Arr_Comp_Id_Len (ArrLen => ArrLen);
      --  if ArrLen > 0 then
      --     for I in 0 .. ArrLen - 1 loop
      --        Get_Fw_Info (Input_Component_Id => All_Comp_Id(I),
      --                 Output_Component_Id => Component_Infos(Component_Length).Id,
      --                 Fw_Size      => Component_Infos(Component_Length).Fw_Size,
      --                 Fw_Offset    => Component_Infos(Component_Length).Fw_Offset,
      --                 Ap_Sku_Id    => Component_Infos(Component_Length).Ap_Sku_Id,
      ...
      --        if  Is_Valid = 1
      --        then
      --           -- get active/pending stamp and version string for ap
      --           Get_Ap_Active_Stamp (Stamp => Component_Infos(Component_Length).Stamp);
      --           Get_Ap_Pending_Stamp (Stamp => Component_Infos(Component_Length).Pending_Stamp);
      --           Get_Ap_Active_Version_String
      --              (Version_String => Component_Infos(Component_Length).Version_String,
      --              Length         => Component_Infos(Component_Length).Version_String_Length);
      --           Get_Ap_Pending_Version_String
      --              (Version_String => Component_Infos(Component_Length).Pending_Version_String,
      --              Length         => Component_Infos(Component_Length).Pending_Version_String_Length);
      --           Component_Infos(Component_Length).Active_Method := DEFAULT_PLDMFW_ACTIVE_METHOD;
      --           Component_Length := Component_Length + 1;
   ...
   begin
      ...
      --  Pldm_Update_Pds(Component_Id   => Component_Id,
      --                  Status  => Status,
      --                  Err     => Err);
   ...
   is
      Mcu_Component_Id    : NvU16 := 16#FF02#;
      ...
      subtype Arr_Idx_4_Buffer is ARR_NvU8_IDX32 (0 .. 3) with
          Object_Size => 32;
      function Uc_U32_To_Array is new Ada.Unchecked_Conversion
        (Source => NvU32, Target => Arr_Idx_4_Buffer);

      subtype Arr_Idx_2_Buffer is ARR_NvU8_IDX32 (0 .. 1) with
          Object_Size => 16;
      function Uc_U16_To_Array is new Ada.Unchecked_Conversion
        (Source => NvU16, Target => Arr_Idx_2_Buffer);

      --  ArrLen            : NvU32 := 0;
      --  Unused_Comp_Id: NvU16 := 0;
      --  All_Comp_Id : Comp_Id_Array with Address => Get_Arr_Comp_id_Address;
   begin
      ...
      --  Get_Fw_Info (Input_Component_Id => Mcu_Component_Id,
      --               Output_Component_Id => Mcu_Component_Id,
      ...
      --  iana
      Device_Descriptors (Device_Descriptors_Count).Descriptor_Type :=
        DESCRIPTOR_ID_TYPE_IANA_ENTERPRISE_ID;
      Device_Descriptors (Device_Descriptors_Count).Length          :=
        DESCRIPTOR_ID_LENS_IANA_ENTERPRISE_ID;
      Device_Descriptors (Device_Descriptors_Count).Data
        (0 .. (DESCRIPTOR_ID_LENS_IANA_ENTERPRISE_ID - 1))          :=
      ...
      --  pci vendor id
      Device_Descriptors (Device_Descriptors_Count).Descriptor_Type :=
        DESCRIPTOR_ID_TYPE_PCI_VENDOR_ID;
      Device_Descriptors (Device_Descriptors_Count).Length := DESCRIPTOR_ID_LENS_PCI_VENDOR_ID;
      Device_Descriptors (Device_Descriptors_Count).Data
        (0 .. (DESCRIPTOR_ID_LENS_PCI_VENDOR_ID - 1))               :=
        Uc_U16_To_Array (Vendor_Id);
      Device_Descriptors_Count := Device_Descriptors_Count + 1;

      --  pci device id
      Device_Descriptors (Device_Descriptors_Count).Descriptor_Type :=
        DESCRIPTOR_ID_TYPE_PCI_DEVICE_ID;
      Device_Descriptors (Device_Descriptors_Count).Length := DESCRIPTOR_ID_LENS_PCI_DEVICE_ID;
      Device_Descriptors (Device_Descriptors_Count).Data
        (0 .. (DESCRIPTOR_ID_LENS_PCI_DEVICE_ID - 1))               :=
        Uc_U16_To_Array (Device_Id);
      Device_Descriptors_Count := Device_Descriptors_Count + 1;

      --  pci subsystem vendor id
      Device_Descriptors (Device_Descriptors_Count).Descriptor_Type :=
        DESCRIPTOR_ID_TYPE_PCI_SUBSYSTEM_VENDOR_ID;
      Device_Descriptors (Device_Descriptors_Count).Length          :=
        DESCRIPTOR_ID_LENS_PCI_SUBSYSTEM_VENDOR_ID;
      Device_Descriptors (Device_Descriptors_Count).Data
        (0 .. (DESCRIPTOR_ID_LENS_PCI_SUBSYSTEM_VENDOR_ID - 1))     :=
        Uc_U16_To_Array (Subsystem_Vendor_Id);
      Device_Descriptors_Count := Device_Descriptors_Count + 1;

      --  pci subsystem device id
      Device_Descriptors (Device_Descriptors_Count).Descriptor_Type :=
        DESCRIPTOR_ID_TYPE_PCI_SUBSYSTEM_DEVICE_ID;
      Device_Descriptors (Device_Descriptors_Count).Length          :=
        DESCRIPTOR_ID_LENS_PCI_SUBSYSTEM_DEVICE_ID;
      Device_Descriptors (Device_Descriptors_Count).Data
        (0 .. (DESCRIPTOR_ID_LENS_PCI_SUBSYSTEM_DEVICE_ID - 1))     :=
        Uc_U16_To_Array (Subsystem_Device_Id);
      Device_Descriptors_Count := Device_Descriptors_Count + 1;

      --  apsku
      Vendor_Descriptors (Vendor_Descriptors_Count).String_Type := FW_STR_TYPE_ASCII;
      Vendor_Descriptors (Vendor_Descriptors_Count).String_Length             :=
        Pldm_Vendor_Defined_Descriptor_Title_String_Apsku'Length;
      Vendor_Descriptors (Vendor_Descriptors_Count).String
      ...
      Vendor_Descriptors (Vendor_Descriptors_Count).Data (0 .. 3)             :=
        Uc_U32_To_Array (Ap_Sku_Id);
      ...
      --     for I in 0 .. ArrLen - 1 loop
      --        Get_Fw_Info (Input_Component_Id => All_Comp_Id(I),
      --                    Output_Component_Id => Unused_Comp_Id,
      --                    Fw_Size      => Unused_Fw_Size,
      --                    Fw_Offset    => Unused_Fw_Offset,
      --                    Ap_Sku_Id    => Ap_Sku_Id,
      --                    Build_Mode   => Unused_Build_Mode,
   ...
   begin
      null;
      --  Get_Fw_Info (Input_Component_Id => Component_Id,
   ...
   is
      ...
      Mcu_Component_Id : constant NvU16 := 16#FF02#;
   begin
      ...
      then
         ...
         --  rel = 0, dev = 1, dbg = 2
         if Build_Mode = 0 and then Ap_Sku_Id /= 0
         then
         ...
         if Is_Force_Update = False and then Fw_State = Uc_Update_State_To_U8 (Stage)
         then
            --  check stamp
      ...
      -- else other component, skip auth header

      <<Exit_Point>>
      if Ret = Pldmfw_Ret_Success
      then
         Pldm_Hook_Set_Update_State
           (Component_Id => Component_Id, Status => UPDATE_INPROGRESS, Ret => Ret);
      end if;
   ...
   begin
      ...
      Pldm_Hook_Set_Log
        (Event => Activate, Info0 => NvU8 ("and" (Component_Id, 16#0000_0000_0000_00FF#)),
         Info1 => NvU8 ("and" (Safe_Shift_Right (Component_Id, 8), 16#0000_0000_0000_00FF#)));

      if Is_Valid = 1
      then
         Pldm_Hook_Set_Update_State
           (Component_Id => Component_Id, Status => UPDATE_COMPLETE, Ret => Ret);
      end if;
   ...
   is
      ...
      function Uc_U32_To_Record is new Ada.Unchecked_Conversion
        (Source => NvU32, Target => U32_Record);
   begin
   ...
   begin
      ...
      Pldm_Hook_Set_Log
        (Event => Stage_Update, Info0 => NvU8 ("and" (Component_Id, 16#0000_0000_0000_00FF#)),
         Info1 => NvU8 ("and" (Safe_Shift_Right (Component_Id, 8), 16#0000_0000_0000_00FF#)));

      if Is_Valid = 1
      then
         Pldm_Hook_Set_Update_State
           (Component_Id => Component_Id, Status => UPDATE_STAGED, Ret => Ret);
      end if;
   ...
   begin
      ...
      if Is_Valid = 1 and then Fw_State = Uc_Update_State_To_U8 (Stage)
      then
         Is_Staged := True;
      end if;
   ...
   begin
      null;
      --  Request_Authentication (Comp_Id => Component_Id, Auth_Request_id => Auth_Request_id);

   end Pldm_Hook_Request_Authenticate;

   procedure Pldm_Hook_Get_Limited_Rate_Info (Info : out Limited_Rate_Info) is
   begin
      --  Get_Limited_Rate_Info (Info => Info);
      null;
