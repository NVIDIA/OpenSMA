...
package body RFLX.SPDM.Nonce with
  SPARK_Mode
is
   ...
   function Successor (Ctx : Context; Fld : Field) return Virtual_Field is
    ...
    with
     Pre =>
       ...
       and RFLX.SPDM.Nonce.Structural_Valid (Ctx, Fld)
       and RFLX.SPDM.Nonce.Valid_Predecessor (Ctx, Fld);
   ...
   procedure Initialize_Data_Private (Ctx : in out Context; Length : RFLX_Types.Length) with
     Pre =>
       ...
       and then RFLX.SPDM.Nonce.Field_First (Ctx, RFLX.SPDM.Nonce.F_Data) mod RFLX_Types.Byte'Size = 1,
     Post =>
       Has_Buffer (Ctx)
