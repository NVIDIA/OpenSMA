...
package RFLX.SPDM_Responder.Opaque_Data with
  SPARK_Mode,
  Annotate =>
...
is
   ...
   procedure Reset (Ctx : in out Context) with
     Pre =>
       not Ctx'Constrained
       and RFLX.SPDM_Responder.Opaque_Data.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Take_Buffer (Ctx : in out Context; Buffer : out RFLX_Types.Bytes_Ptr) with
     Pre =>
       RFLX.SPDM_Responder.Opaque_Data.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and Buffer /= null
   ...
   procedure Copy (Ctx : Context; Buffer : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.SPDM_Responder.Opaque_Data.Has_Buffer (Ctx)
       and then RFLX.SPDM_Responder.Opaque_Data.Structural_Valid_Message (Ctx)
       and then RFLX.SPDM_Responder.Opaque_Data.Byte_Size (Ctx) = Buffer'Length;
   ...
   procedure Generic_Write (Ctx : in out Context; Offset : RFLX_Types.Length := 0) with
     Pre =>
       not Ctx'Constrained
       and then RFLX.SPDM_Responder.Opaque_Data.Has_Buffer (Ctx)
       and then Offset < RFLX.SPDM_Responder.Opaque_Data.Buffer_Length (Ctx)
       and then Pre (RFLX.SPDM_Responder.Opaque_Data.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   procedure Data (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.SPDM_Responder.Opaque_Data.Has_Buffer (Ctx)
       and then RFLX.SPDM_Responder.Opaque_Data.Structural_Valid_Message (Ctx)
       and then Data'Length = RFLX.SPDM_Responder.Opaque_Data.Byte_Size (Ctx);
   ...
   function Path_Condition (Ctx : Context; Fld : Field) return Boolean with
     Pre =>
       RFLX.SPDM_Responder.Opaque_Data.Valid_Predecessor (Ctx, Fld),
     Post =>
       True;
   ...
   function Field_Condition (Ctx : Context; Fld : Field) return Boolean with
     Pre =>
       RFLX.SPDM_Responder.Opaque_Data.Has_Buffer (Ctx)
       and then RFLX.SPDM_Responder.Opaque_Data.Valid_Predecessor (Ctx, Fld)
       and then RFLX.SPDM_Responder.Opaque_Data.Valid_Next (Ctx, Fld)
       and then RFLX.SPDM_Responder.Opaque_Data.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   function Field_Size (Ctx : Context; Fld : Field) return RFLX_Types.Bit_Length with
     Pre =>
       RFLX.SPDM_Responder.Opaque_Data.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Data =>
   ...
   function Equal (Ctx : Context; Fld : Field; Data : RFLX_Types.Bytes) return Boolean with
     Pre =>
       RFLX.SPDM_Responder.Opaque_Data.Has_Buffer (Ctx)
       and RFLX.SPDM_Responder.Opaque_Data.Valid_Next (Ctx, Fld);
   ...
   function Get_Length (Ctx : Context) return RFLX.SPDM.Length_16 with
     Pre =>
       RFLX.SPDM_Responder.Opaque_Data.Valid (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Length);
   ...
   function Get_Data (Ctx : Context) return RFLX_Types.Bytes with
     ...
     Pre =>
       RFLX.SPDM_Responder.Opaque_Data.Has_Buffer (Ctx)
       and then RFLX.SPDM_Responder.Opaque_Data.Structural_Valid (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data)
       and then RFLX.SPDM_Responder.Opaque_Data.Valid_Next (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data),
     Post =>
   ...
   procedure Get_Data (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.SPDM_Responder.Opaque_Data.Structural_Valid (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data)
       and then RFLX.SPDM_Responder.Opaque_Data.Valid_Next (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data)
       and then Data'Length = RFLX_Types.To_Length (RFLX.SPDM_Responder.Opaque_Data.Field_Size (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data)),
     Post =>
   ...
   procedure Generic_Get_Data (Ctx : Context) with
     Pre =>
       RFLX.SPDM_Responder.Opaque_Data.Has_Buffer (Ctx)
       and RFLX.SPDM_Responder.Opaque_Data.Present (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data);
   ...
   procedure Set_Length (Ctx : in out Context; Val : RFLX.SPDM.Length_16) with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.SPDM_Responder.Opaque_Data.Has_Buffer (Ctx)
       and then RFLX.SPDM_Responder.Opaque_Data.Valid_Next (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Length)
       and then RFLX.SPDM.Valid_Length_16 (RFLX.SPDM.To_Base_Integer (Val))
       and then RFLX.SPDM_Responder.Opaque_Data.Available_Space (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Length) >= RFLX.SPDM_Responder.Opaque_Data.Field_Size (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Length)
       and then RFLX.SPDM_Responder.Opaque_Data.Field_Condition (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Data_Empty (Ctx : in out Context) with
     Pre =>
       ...
       and then RFLX.SPDM_Responder.Opaque_Data.Has_Buffer (Ctx)
       and then RFLX.SPDM_Responder.Opaque_Data.Valid_Next (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data)
       and then RFLX.SPDM_Responder.Opaque_Data.Available_Space (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data) >= RFLX.SPDM_Responder.Opaque_Data.Field_Size (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data)
       and then RFLX.SPDM_Responder.Opaque_Data.Field_Condition (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data)
       and then RFLX.SPDM_Responder.Opaque_Data.Field_Size (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Data (Ctx : in out Context; Data : RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.SPDM_Responder.Opaque_Data.Valid_Next (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data)
       and then RFLX.SPDM_Responder.Opaque_Data.Available_Space (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data) >= RFLX.SPDM_Responder.Opaque_Data.Field_Size (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data)
       and then RFLX.SPDM_Responder.Opaque_Data.Valid_Length (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data, Data'Length)
       and then RFLX.SPDM_Responder.Opaque_Data.Available_Space (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.SPDM_Responder.Opaque_Data.Field_Condition (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data),
     Post =>
       Has_Buffer (Ctx)
       and Structural_Valid (Ctx, F_Data)
   ...
   procedure Generic_Set_Data (Ctx : in out Context; Length : RFLX_Types.Length) with
     Pre =>
       ...
       and then RFLX.SPDM_Responder.Opaque_Data.Valid_Next (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data)
       and then RFLX.SPDM_Responder.Opaque_Data.Available_Space (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data) >= RFLX.SPDM_Responder.Opaque_Data.Field_Size (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data)
       and then RFLX.SPDM_Responder.Opaque_Data.Valid_Length (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data, Length)
       and then RFLX_Types.To_Length (RFLX.SPDM_Responder.Opaque_Data.Available_Space (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Data)) >= Length
   ...
   type Structure is
      record
         ...
         Data : RFLX_Types.Bytes (RFLX_Types.Index'First .. RFLX_Types.Index'First + 4094);
      end record;
   ...
   procedure To_Context (Struct : Structure; Ctx : in out Context) with
     Pre =>
       not Ctx'Constrained
       and then RFLX.SPDM_Responder.Opaque_Data.Has_Buffer (Ctx)
       and then RFLX.SPDM_Responder.Opaque_Data.Valid_Structure (Struct)
       and then RFLX.SPDM_Responder.Opaque_Data.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.SPDM_Responder.Opaque_Data.Field_First (Ctx, RFLX.SPDM_Responder.Opaque_Data.F_Length) rem RFLX_Types.Byte'Size = 1
...
end RFLX.SPDM_Responder.Opaque_Data;
