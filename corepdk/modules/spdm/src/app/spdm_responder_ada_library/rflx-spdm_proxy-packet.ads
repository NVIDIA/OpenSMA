...
package RFLX.SPDM_Proxy.Packet with
  SPARK_Mode,
  Annotate =>
...
is
   ...
   procedure Reset (Ctx : in out Context) with
     Pre =>
       not Ctx'Constrained
       and RFLX.SPDM_Proxy.Packet.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Take_Buffer (Ctx : in out Context; Buffer : out RFLX_Types.Bytes_Ptr) with
     Pre =>
       RFLX.SPDM_Proxy.Packet.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and Buffer /= null
   ...
   procedure Copy (Ctx : Context; Buffer : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.SPDM_Proxy.Packet.Has_Buffer (Ctx)
       and then RFLX.SPDM_Proxy.Packet.Structural_Valid_Message (Ctx)
       and then RFLX.SPDM_Proxy.Packet.Byte_Size (Ctx) = Buffer'Length;
   ...
   procedure Generic_Write (Ctx : in out Context; Offset : RFLX_Types.Length := 0) with
     Pre =>
       not Ctx'Constrained
       and then RFLX.SPDM_Proxy.Packet.Has_Buffer (Ctx)
       and then Offset < RFLX.SPDM_Proxy.Packet.Buffer_Length (Ctx)
       and then Pre (RFLX.SPDM_Proxy.Packet.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   procedure Data (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.SPDM_Proxy.Packet.Has_Buffer (Ctx)
       and then RFLX.SPDM_Proxy.Packet.Structural_Valid_Message (Ctx)
       and then Data'Length = RFLX.SPDM_Proxy.Packet.Byte_Size (Ctx);
   ...
   function Path_Condition (Ctx : Context; Fld : Field) return Boolean with
     Pre =>
       RFLX.SPDM_Proxy.Packet.Valid_Predecessor (Ctx, Fld),
     Post =>
       True;
   ...
   function Field_Condition (Ctx : Context; Fld : Field) return Boolean with
     Pre =>
       RFLX.SPDM_Proxy.Packet.Has_Buffer (Ctx)
       and then RFLX.SPDM_Proxy.Packet.Valid_Predecessor (Ctx, Fld)
       and then RFLX.SPDM_Proxy.Packet.Valid_Next (Ctx, Fld)
       and then RFLX.SPDM_Proxy.Packet.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   function Field_Size (Ctx : Context; Fld : Field) return RFLX_Types.Bit_Length with
     Pre =>
       RFLX.SPDM_Proxy.Packet.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Data =>
   ...
   function Equal (Ctx : Context; Fld : Field; Data : RFLX_Types.Bytes) return Boolean with
     Pre =>
       RFLX.SPDM_Proxy.Packet.Has_Buffer (Ctx)
       and RFLX.SPDM_Proxy.Packet.Valid_Next (Ctx, Fld);
   ...
   function Get_Data (Ctx : Context) return RFLX_Types.Bytes with
     ...
     Pre =>
       RFLX.SPDM_Proxy.Packet.Has_Buffer (Ctx)
       and then RFLX.SPDM_Proxy.Packet.Structural_Valid (Ctx, RFLX.SPDM_Proxy.Packet.F_Data)
       and then RFLX.SPDM_Proxy.Packet.Valid_Next (Ctx, RFLX.SPDM_Proxy.Packet.F_Data),
     Post =>
   ...
   procedure Get_Data (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.SPDM_Proxy.Packet.Structural_Valid (Ctx, RFLX.SPDM_Proxy.Packet.F_Data)
       and then RFLX.SPDM_Proxy.Packet.Valid_Next (Ctx, RFLX.SPDM_Proxy.Packet.F_Data)
       and then Data'Length = RFLX_Types.To_Length (RFLX.SPDM_Proxy.Packet.Field_Size (Ctx, RFLX.SPDM_Proxy.Packet.F_Data)),
     Post =>
   ...
   procedure Generic_Get_Data (Ctx : Context) with
     Pre =>
       RFLX.SPDM_Proxy.Packet.Has_Buffer (Ctx)
       and RFLX.SPDM_Proxy.Packet.Present (Ctx, RFLX.SPDM_Proxy.Packet.F_Data);
   ...
   procedure Set_Data_Empty (Ctx : in out Context) with
     Pre =>
       ...
       and then RFLX.SPDM_Proxy.Packet.Has_Buffer (Ctx)
       and then RFLX.SPDM_Proxy.Packet.Valid_Next (Ctx, RFLX.SPDM_Proxy.Packet.F_Data)
       and then RFLX.SPDM_Proxy.Packet.Available_Space (Ctx, RFLX.SPDM_Proxy.Packet.F_Data) >= RFLX.SPDM_Proxy.Packet.Field_Size (Ctx, RFLX.SPDM_Proxy.Packet.F_Data)
       and then RFLX.SPDM_Proxy.Packet.Field_Condition (Ctx, RFLX.SPDM_Proxy.Packet.F_Data)
       and then RFLX.SPDM_Proxy.Packet.Field_Size (Ctx, RFLX.SPDM_Proxy.Packet.F_Data) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Initialize_Data (Ctx : in out Context; Length : RFLX_Types.Length) with
     Pre =>
       ...
       and then RFLX.SPDM_Proxy.Packet.Has_Buffer (Ctx)
       and then RFLX.SPDM_Proxy.Packet.Valid_Next (Ctx, RFLX.SPDM_Proxy.Packet.F_Data)
       and then RFLX.SPDM_Proxy.Packet.Valid_Length (Ctx, RFLX.SPDM_Proxy.Packet.F_Data, Length)
       and then RFLX.SPDM_Proxy.Packet.Available_Space (Ctx, RFLX.SPDM_Proxy.Packet.F_Data) >= RFLX_Types.To_Bit_Length (Length),
     Post =>
       Has_Buffer (Ctx)
       and Structural_Valid (Ctx, F_Data)
   ...
   procedure Set_Data (Ctx : in out Context; Data : RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.SPDM_Proxy.Packet.Valid_Next (Ctx, RFLX.SPDM_Proxy.Packet.F_Data)
       and then RFLX.SPDM_Proxy.Packet.Available_Space (Ctx, RFLX.SPDM_Proxy.Packet.F_Data) >= RFLX.SPDM_Proxy.Packet.Field_Size (Ctx, RFLX.SPDM_Proxy.Packet.F_Data)
       and then RFLX.SPDM_Proxy.Packet.Valid_Length (Ctx, RFLX.SPDM_Proxy.Packet.F_Data, Data'Length)
       and then RFLX.SPDM_Proxy.Packet.Available_Space (Ctx, RFLX.SPDM_Proxy.Packet.F_Data) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.SPDM_Proxy.Packet.Field_Condition (Ctx, RFLX.SPDM_Proxy.Packet.F_Data),
     Post =>
       Has_Buffer (Ctx)
       and Structural_Valid (Ctx, F_Data)
   ...
   procedure Generic_Set_Data (Ctx : in out Context; Length : RFLX_Types.Length) with
     Pre =>
       ...
       and then RFLX.SPDM_Proxy.Packet.Available_Space (Ctx, RFLX.SPDM_Proxy.Packet.F_Data) >= RFLX.SPDM_Proxy.Packet.Field_Size (Ctx, RFLX.SPDM_Proxy.Packet.F_Data)
       and then RFLX.SPDM_Proxy.Packet.Valid_Length (Ctx, RFLX.SPDM_Proxy.Packet.F_Data, Length)
       and then RFLX_Types.To_Length (RFLX.SPDM_Proxy.Packet.Available_Space (Ctx, RFLX.SPDM_Proxy.Packet.F_Data)) >= Length
...
private
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.SPDM_Proxy.Packet.Field_First (Ctx, RFLX.SPDM_Proxy.Packet.F_Data) rem RFLX_Types.Byte'Size = 1
