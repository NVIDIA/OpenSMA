...
// for spdm v1.2
pdk::spdm::app::res::capabilities::ChunkCap get_flag_chunk();
// for spdm v1.2
pdk::spdm::app::res::capabilities::AliasCertCap get_flag_alias_cert();
// for spdm v1.2
pdk::spdm::app::res::capabilities::SetCertCap get_flag_set_cert();
// for spdm v1.2
pdk::spdm::app::res::capabilities::CsrCap get_flag_csr();
// for spdm v1.2
pdk::spdm::app::res::capabilities::CertInstallResetCap get_flag_cert_install_reset();
