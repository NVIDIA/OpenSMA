#pragma once
#include "crypto/ec/pdk-spdm-app-res-crypto-ec-plat.h"
...
namespace constants {
// Curve private key sizes (bytes)
constexpr size_t P256_PRIVATE_KEY_SIZE = 32;
constexpr size_t P384_PRIVATE_KEY_SIZE = 48;
constexpr size_t P521_PRIVATE_KEY_SIZE = 66;

// Curve public key sizes (bytes) - X and Y coordinates combined
constexpr size_t P256_PUBLIC_KEY_SIZE = 64;   // 32 * 2
constexpr size_t P384_PUBLIC_KEY_SIZE = 96;   // 48 * 2
constexpr size_t P521_PUBLIC_KEY_SIZE = 132;  // 66 * 2

// Hash sizes (bytes)
constexpr size_t SHA256_HASH_SIZE = 32;
constexpr size_t SHA384_HASH_SIZE = 48;
constexpr size_t SHA512_HASH_SIZE = 64;

// OpenSSL NID values for curves
constexpr size_t NID_X9_62_PRIME256V1 = 415;  // P-256
constexpr size_t NID_SECP384R1        = 715;  // P-384
constexpr size_t NID_SECP521R1        = 716;  // P-521

// OpenSSL NID values for hash algorithms
constexpr size_t NID_SHA256 = 672;
constexpr size_t NID_SHA384 = 673;
constexpr size_t NID_SHA512 = 674;
}  // namespace constants
 ...
 **/
bool libspdm_ec_set_pub_key(void*          ec_context,
