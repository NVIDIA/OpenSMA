 ...
 * @retval false  The key is set unsuccessfully.
 **/
bool libspdm_hmac_sha3_256_set_key(void*          hmac_sha3_256_ctx,
                                   const uint8_t* key,
                                   size_t         key_size);
 ...
 * @retval false  This interface is not supported.
 **/
bool libspdm_hmac_sha3_384_set_key(void*          hmac_sha3_384_ctx,
                                   const uint8_t* key,
                                   size_t         key_size);
 ...
 * @retval false  This interface is not supported.
 **/
bool libspdm_hmac_sha3_512_set_key(void*          hmac_sha3_512_ctx,
                                   const uint8_t* key,
                                   size_t         key_size);
