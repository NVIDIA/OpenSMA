...
struct HashAlgoDigestSize
{
    ...
    static constexpr size_t TpmAlgSm3_256Size  = 256 / 8;
};
...
struct AsymAlgoSignatureSize
{
    ...
    static constexpr size_t TpmAlgSm2EccSm2P256Size    = 64;
    static constexpr size_t TpmAlgEddsaEd25519Size     = 64;
    static constexpr size_t TpmAlgEddsaEd448Size       = 114;
};
