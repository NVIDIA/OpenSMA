...
{
    platforms::PrivateHeader                     priv;  ///< private header
    TransportHeader                              hdr;   ///< mctp header
    std::array<uint8_t, platforms::TransmitUnit> msg;   ///< mctp message body
    ...
    {
        pdk::cmn::flowcontrol::corepdk_assert(data.size() >= sizeof(Packet),
